          ...
          >
            <div class="comment-card" v-for="(item,index) in list" :key="item.commentid">
              <van-swipe-cell>
                ...
                <div class="news-card" v-if="item.news!=null" >
                  <div class="top">
                    <div class="top-left1" >
                     <van-image :src="picIp+item.news.image"></van-image>
                      <div class="user">
                        {{item.news.username}}
                      </div>
                    </div>
                  ...
                  <div class="card" @click="getDetail(item.news.newsid)">
                    <div class="card-left">
                ...
                <template #right>
                  <van-button square text="删除" type="danger" class="delete-button" @click="removeComment(index,item.commentid)"/>
                </template>
              </van-swipe-cell>
            </div>
          </van-list>
